  ...
  return (
    ...
    >
      <VStack spacing={2} justify="center" align={"center"}>
        <Text as="u" fontSize={12} align="center" color="000">
          Hidratante Neutrogena Hydro Boost
        </Text>
        <Image
          height={90}
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9kgSsqP_GGkHLY287QQd21hMR_d2qUDCSjQ&usqp=CAU"
          alt="Hidratante Neutrogena Hydro Boost"
        />
        <HStack sapcing={2}>
          <Wrap>
            <WrapItem>
